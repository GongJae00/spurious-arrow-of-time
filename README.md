...
The method is a six-gate cue-locality audit on factor-intervenable temporal benchmarks: G1 core learnable, G2 nuisance predictive, G3 endpoint controlled, G4 no-spurious recovery, G5 reversal signature, G6 cue locality (frame-local, order-invariant multi-frame, or order-encoded). The generator makes each gate independently testable.
